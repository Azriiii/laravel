                ...
                <div class="card">
                    ...
                    <div class="card-content pb-4">
                        <div class="recent-message d-flex px-4 py-3">
                            ...
                            <div class="name ms-4">
                                <h5 class="mb-1">Frank Abgniel</h5>
                                <h6 class="text-muted mb-0">@Franz</h6>
                            </div>
                        </div>
                        <div class="recent-message d-flex px-4 py-3">
                            <div class="avatar avatar-lg">
                            ...
                            <div class="name ms-4">
                                <h5 class="mb-1">Alex Fride</h5>
                                <h6 class="text-muted mb-0">@dzgre</h6>
                            </div>
                        </div>
                        <div class="recent-message d-flex px-4 py-3">
                            <div class="avatar avatar-lg">
                            ...
                            <div class="name ms-4">
                                <h5 class="mb-1">Jonath pikao</h5>
                                <h6 class="text-muted mb-0">@Mlokd</h6>
                            </div>
                        </div>
                        <div class="px-4">
